...
class Book(Genre):
    def __init__(self, title, author, ISBN, publication_date, availability, genre_name, genre_description, genre_category):
        self.__title = title
        self.__author = author
        self.__isbn = ISBN
        self.__publication_date = publication_date
        self.__availability = availability
        super().__init__(genre_name, genre_description, genre_category)
    def getTitle(self):
        return self.__title
